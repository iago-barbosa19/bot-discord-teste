...
class Log:
    ...
    def assemble_exception_message(self: object, message: str, exception_occurrence: Exception) -> str:
        ...
        return_value = f'{"" if exception_occurrence is None else f"{message} ---"} Motive: {exception_motive} | Cause: {exception_cause} | Line: {exception_line} |'
        return return_value
    ...
    @classmethod
    def get_logger(self: Literal['Log'], logger_configs = None) -> Literal['Log']:
        """
        ...
        Params:
            ...
            opening_method (str): The method of opening of the Log File ['w+', 'a+']
            encoding_method (str): The method of encoding ['utf-8', 'iso-8859-3']
            debug_level (CONSTANT): The debugging level of the logger (Use the constants of the class, like INFO, DEBUG, WARN, CRITICAL AND ERROR)
